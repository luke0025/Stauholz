...
btn.addEventListener('click', function(){
    let input = document.querySelector('#postnummer')
    let inputzip = input.value
       let index = dataZipcodeZones.findIndex(function(x){
        return x.zip == inputzip
        })

        let zone = dataZipcodeZones[index].zone;
       console.log("index " + index)
    console.log("zone " + zone)


  // return zone priser per kilo.
let weight = document.querySelector('#weight').value; // weight in kg
  ...
  if (weight <= 4.99) {
    ...
    pricesPerZone = {
      ...
      console.log(pricesPerZone);
        let price = pricesPerZone[zone]
        console.log("final price " + price);
        document.querySelector('#box').innerHTML = price + " kr"
